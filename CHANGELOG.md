...
All notable changes to the "prompt-foundry" extension will be documented in this file.
...
### Added
- **Evolving Blocks System**: Introduced a self-improving prompt library where AI can propose and commit updates via MCP.
